...
近 40 年来，[*O’Reilly Media*](http://oreilly.com)一直致力于为企业提供技术和业务培训，知识和洞察，帮助其取得成功。

我们独特的专家和创新者网络通过书籍、文章和我们的在线学习平台分享他们的知识和专长。O’Reilly 的在线学习平台为您提供按需访问实时培训课程、深度学习路径、交互式编码环境以及来自 O’Reilly 和其他 200 多个出版商的大量文本和视频。更多信息，请访问[*http://oreilly.com*](http://oreilly.com)。
...
我们为本书准备了一个网页，列出了勘误、示例和任何额外信息。您可以访问[*https://oreil.ly/AnalyticalSkills_AI_DS*](https://oreil.ly/AnalyticalSkills_AI_DS)获取这个页面。

发邮件至*bookquestions@oreilly.com* 就本书的评论或技术问题发表意见或提问。

关于我们的书籍和课程的更多新闻和信息，请访问我们的网站[*http://www.oreilly.com*](http://www.oreilly.com)。
